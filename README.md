...
Micro-C is a minimal C compiler written in C, designed for educational purposes to demonstrate compiler design (lexer, parser, semantic analysis, code generation). It compiles a subset of C to x86 assembly on POSIX systems.
